...
class PerformBoundaryTraversalOnABinaryTree {
    ...
    public static void printRightBoundary(NodeData root)
    {
    ...
    public static void printLeafNodes(NodeData root)
    {
        // base case
        if (root == null) {
            return;
    ...
    public static void performBoundaryTraversal(NodeData root)
    {
        // base case
        if (root == null) {
            return;
    ...
    public static void main(String[] args)
    {
        ...
        root.left.left.left = new NodeData(8);
        root.left.left.right = new NodeData(9);
        root.left.right.right = new NodeData(10);
        root.right.right.left = new NodeData(11);
        root.left.left.right.left = new NodeData(12);
        root.left.left.right.right = new NodeData(13);
        root.right.right.left.left = new NodeData(14);
