...
class FindShortestPathFromSourceToDestinationInAMatrixThatSatisfiesGivenConstraints
{
    // N x N matrix
...
class FindShortestPathFromSourceToDestinationInAMatrixThatSatisfiesGivenConstraintsA2
{
    // N x N matrix
    private static int N;
