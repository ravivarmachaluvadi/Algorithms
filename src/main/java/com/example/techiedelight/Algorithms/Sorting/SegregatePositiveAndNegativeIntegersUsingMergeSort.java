...
class SegregatePositiveAndNegativeIntegersUsingMergeSort
{
    // merge two subarrays arr[low.. mid] and arr[mid+1.. high]
    // such that negative numbers are followed by all positive numbers
    ...
    // Segregate positive and negative integers using mergesort-like routine.
