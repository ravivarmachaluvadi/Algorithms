...
class HybridQuickSortAlgorithm
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Average time taken by Non-Optimized quicksort: " + t1/NUM + "ns");
        System.out.println("Average time taken by Optimized quicksort: " + t2/NUM + "ns");
    }
}