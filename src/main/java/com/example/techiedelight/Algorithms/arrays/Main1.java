...
class FindCountOfDistinctElementsInEverySubArrayOfSizeK
{
...
class FindCountOfDistinctElementsInEverySubArrayOfSizeKA1
{
...
class FindCountOfDistinctElementsInEverySubArrayOfSizeKA2
{
    // Function to find the count of distinct elements in every sub-array
    // of size k in the array
